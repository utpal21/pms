          ...
          <div role="main" class="page-content container container-plus">
            <div class="card bcard mt-2 mt-lg-3">
              ...
              <div class="card-body px-3 pb-1">
				...
				?>
				<form action="<?php echo base_url();?>index.php/super_admin/save_landlord" method="post"  class="mt-lg-3"  enctype="multipart/form-data">
				  ...
				  <div class="form-group row">
					 ...
					 <div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="lpost_code">
                      <span class="floating-label text-grey-m3">
                        Post Code
                    </span>
                    </div>
					 <div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="lcity">
                      <span class="floating-label text-grey-m3">
                        City
                    </span>
                    </div>
					 <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="lcountry">
                      <span class="floating-label text-grey-m3">
                        Country
                    </span>
                    </div>
				  ...
				  <div class="form-group row">
					 ...
					 <div class="col-sm-6 input-floating-label text-blue-d2 brc-blue-m1">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="correspondence_address">
                      <span class="floating-label text-grey-m3">
					 ...
					 <div class="col-sm-6 input-floating-label text-blue-d2 brc-blue-m1">
                        ...
                        <label style="vertical-align:middle;">
						 ...
						 <input type="checkbox" class="mr-2" value="1" name="cors_by_email">Email
                         <input type="checkbox" class="mr-2" value="1" name="cors_by_phone">Phone
						 <input type="checkbox" class="mr-2" value="1" name="cors_by_post">Post
                        </label>
                      </div>
                    </div>
              ...
              <div class="card-body px-3 pb-1">
                 ...
                 <div class="form-group row">
				  ...
				  <div class="form-group row">
					...
					<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="added_by"  value="someone" disabled="disabled">
                      <span class="floating-label text-grey-m3">
                        Added By
                    </span>
                    </div>
				  ...
				  <div class="form-group row">
                   ...
                   <div class="col-sm-6 input-floating-label text-blue-d2 brc-blue-m1">
                        ...
                        <label style="vertical-align:middle;">
						 ...
						 <input type="radio" class="mr-2" id="new1" name="furniture_type" value="0" onChange="showNew1()">Furnished&nbsp;
						 <input type="radio" class="mr-2" id="new2" name="furniture_type" value="1" onChange="showNew2()">Part Furnished&nbsp;
						 <input type="radio" class="mr-2" name="furniture_type"  value="2" onChange="showNew3()">Un-Furnished
						</label>
                      </div>
                    </div>
					<!--<div id="new1Open" style="display: none"> -->
						 <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1" id="new1Open" style="display: none">
						  <textarea class="form-control brc-primary-m2 border-l-2 text-grey-d1" rows="3" placeholder=" New Furniture List" name="new_furniture_list"></textarea>
						 </div>
						 <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1" id="new3Open" style="display: none">
						  <textarea class="form-control brc-primary-m2 border-l-2 text-grey-d1" rows="3" placeholder="Used Furniture List" name="used_furniture_lisr"></textarea>
						 </div>
					<!--</div> -->
					<!--<div id="new2Open" style="display: none"> -->
						 <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1" id="new2Open" style="display: none">
						  <textarea class="form-control brc-primary-m2 border-l-2 text-grey-d1" rows="3" placeholder=" New Furniture List" name="new_furniture_list"></textarea>
						 </div>
						 <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1" id="new4Open" style="display: none">
						  <textarea class="form-control brc-primary-m2 border-l-2 text-grey-d1" rows="3" placeholder="Used Furniture List" name="used_furniture_lisr"></textarea>
						 </div>
					<!--</div> -->
              ...
              <div class="card-body px-3 pb-1">
                 ...
                 <div class="form-group row">
					  ...
					  <span>Gas</span><hr>
					   ...
					   <div id="id-daterange-wrapper" class="pos-rel">
                        ...
                        <div class="form-row">
                          <div class="col">
                             <div class="pos-rel">
								  <input type="text" class="form-control" id="id-date-1_9" name="gas_from">
								   <span class="floating-label text-grey-m3">
									Date From
								   </span>
							  </div>
                          ...
                          <div class="col">
                        			 <div class="pos-rel">
										  <input type="text" class="form-control" id="id-date-1_10" name="gas_to">
										   <span class="floating-label text-grey-m3">
											Date To
										   </span>
									  </div>
					 ...
					 <div class="col-sm-4 input-floating-label text-blue-d2 brc-blue-m1">
					   ...
					   <div id="id-daterange-wrapper" class="pos-rel">
                        ...
                        <div class="form-row">
                          <div class="col">
                             <div class="pos-rel">
								  <input type="text" class="form-control" id="id-date-1_2" name="electricity_from">
								   <span class="floating-label text-grey-m3">
									Date From
								   </span>
							  </div>
                          ...
                          <div class="col">
                        			 <div class="pos-rel">
										  <input type="text" class="form-control" id="id-date-1_3" name="electricity_to">
										   <span class="floating-label text-grey-m3">
											Date To
										   </span>
									  </div>
					 ...
					 <div class="col-sm-4 input-floating-label text-blue-d2 brc-blue-m1">
					   ...
					   <div id="id-daterange-wrapper" class="pos-rel">
                        ...
                        <div class="form-row">
                          <div class="col">
                             <div class="pos-rel">
								  <input type="text" class="form-control" id="id-date-1_4" name="epc_from">
								   <span class="floating-label text-grey-m3">
									Date From
								   </span>
							  </div>
                          ...
                          <div class="col">
                        			 <div class="pos-rel">
										  <input type="text" class="form-control" id="id-date-1_5" name="epc_to">
										   <span class="floating-label text-grey-m3">
											Date To
										   </span>
									  </div>
				   ...
				   <div class="form-group row">
					  ...
					  <span>PAT Test</span><hr>
					   ...
					   <div id="id-daterange-wrapper" class="pos-rel">
                        ...
                        <div class="form-row">
                           <div class="col">
                             <div class="pos-rel">
								  <input type="text" class="form-control" id="id-date-1_6" name="pat_test_from">
								   <span class="floating-label text-grey-m3">
									Date From
								   </span>
							  </div>
                          ...
                          <div class="col">
                        			 <div class="pos-rel">
										  <input type="text" class="form-control" id="id-date-1_7" name="pat_test_to">
										   <span class="floating-label text-grey-m3">
											Date To
										   </span>
									  </div>
					...
					<input type="radio"  value="1" name="fire" class="mr-2">Yes&nbsp;
                     <input type="radio"  value="0"  name="fire"class="mr-2">No&nbsp;
					   	
                    </div>
					 <div class="col-sm-4 input-floating-label text-blue-d2 brc-blue-m1">
                       <span> Carbon de Monoxide Alarm</span><hr>
                       
					 <input type="radio"  value="1" name="carbon" class="mr-2">Yes&nbsp;
                     <input type="radio"  value="0"  name="carbon"class="mr-2">No&nbsp;
              ...
              <div class="card-body px-3 pb-1">
                  <div class="form-group row">
					 ...
					 <span>Agreement Date</span><hr>
                      <div class="pos-rel">
                          <input type="text" class="form-control" id="id-date-1_8" name="agreement_date">
						   <span class="floating-label text-grey-m3">
                        	Date
                    	   </span>
                      </div>
				...
				$("#txtOther4").attr("disabled", "disabled");
				  ...
				  <div class="form-group row">
					 ...
					 <div class="col-sm-12 input-floating-label text-blue-d2 brc-blue-m1">
						<div class="mb-1">
							<label style="vertical-align:middle;">
							 If contract signed by someone onbehalf of Landlord&nbsp;&nbsp;&nbsp;<input type="checkbox" class="mr-2" id="ddlModels" value="1">&nbsp; 
							</label>
						</div>
				   </div>
					<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="txtOther4" name="onbehalf_name" disabled="disabled" />
                      <span class="floating-label text-grey-m3">
                        Name
                    </span>
                    </div>
					<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="txtOther1" name="onbehalf_email" disabled="disabled" />
                      <span class="floating-label text-grey-m3">
                        Email
                    </span>
                    </div>
					<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="txtOther2" name="onbehalf_contact" disabled="disabled" />
                      <span class="floating-label text-grey-m3">
                        Contact
                    </span>
                    </div>
					 ...
					 <div class="col-sm-4 input-floating-label text-blue-d2 brc-blue-m1">
                     <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none"  id="txtOther" name="onbehalf_address" disabled="disabled" />
					  <span class="floating-label text-grey-m3">
                        Contact Address
                    </span>
                    </div>
				  ...
				  <div class="form-group row">
					 ...
					 <div class="col-sm-6 input-floating-label text-blue-d2 brc-blue-m1">
					  ...
					  <div id="openCash" style="display: none">
					  <hr />
					  <input type="text"  class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" name="cash_amount">
					 </div>
                    </div>
				   ...
				   <div class="form-group row">
                     ...
                     <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1"  id="dvPassport" style="display: none">
                      <input type="text"  class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="account_name" >
                      <span class="floating-label text-grey-m3">
                      Account Name
                    </span>
					</div>
					<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1"  id="b1" style="display: none">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="account_no">
                      <span class="floating-label text-grey-m3">
                        Account No
                    </span>
					
                    </div>
					 <div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1"  id="b2" style="display: none">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="sort_code">
                      <span class="floating-label text-grey-m3">
                        Sort Code
                    </span>
                    </div>
					 <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1"  id="b3" style="display: none">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="bank_name">
                      <span class="floating-label text-grey-m3">
                        Bank Name
                    </span>
                    </div>
					 <div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1"  id="b4" style="display: none">
                      <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="amount">
                      <span class="floating-label text-grey-m3">
                        Amount
                    </span>
                    </div>

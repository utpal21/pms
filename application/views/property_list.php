...
if (isset($_POST['matched_tenant']) ? $_POST['matched_tenant'] : '') {
    $tenant_arr = array();
    foreach($_POST['id'] as $row){
        $tenant_arr[$row] = $row;
    }
   $tenant_id_str = join(',', $tenant_arr);
    $query="SELECT * FROM tenant WHERE id IN($tenant_id_str) order by id DESC";
    $res = mysqli_query($con,$query);  
    $tenant_email_arr = array();
    while($row = mysqli_fetch_array($res))
    {
	$tenant_email_arr[$row['email']]=$row['email'];
    }
    $email_to = join(',', $tenant_email_arr);
    
    //START EMAIL
    $sender_mail = 'ashad_cse373@yahoo.com';
    $date_mail = date("Y-m-d");
    $subject_title = "Matched Property";
    $message_details = $home_address; // ai khana home address hoba...

    $message = "<strong>Details:</strong>&nbsp;" . $message_details;
   
    $subject = $subject_title . ' at the date ' . $date_mail;

    $headers = 'MIME-Version: 1.0' . "\r\n";
    $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
    $headers .= 'From: STK Homes UK <info@stkhomes.co.uk>' . "\r\n";
          ...
          <div role="main" class="page-content container container-plus">
            <div class="page-header mb-2 pb-2 flex-column flex-sm-row align-items-start align-items-sm-center py-25 px-1">
              <h1 class="page-title text-primary-d2 text-140">
                ...
                <small class="page-info text-dark-m3">
                  ...
                  showing all property here
                </small>
              </h1>
			   <h3 class="page-title text-primary-d2 text-120">
			   	<a href="<?php echo base_url();?>index.php/super_admin/add_property"><i class="fa fa-plus"></i>
                Add New</a>
               </h3>
            ...
            <div class="card bcard h-auto">
                ...
                <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed">
                  ...
                  <tbody class="pos-rel">
				  <?php foreach ($property_list as $value){ 
				  ...
				  ?>
                    <tr class="d-style bgc-h-default-l4">
                      ...
                      <td>
                        ...
                        <div class="text-95 text-secondary-d1">
                          <?php echo "Landlord Name: ".$row['firstname']." ".$row['surname']." Reg. No.".$value->landlord_reg_no;?>
                        </div>
                      </td>
                    ...
                    <td class="text-grey">
                      ...
                      <!-- <span class="text-105">
                        ...
                        <div class="text-95 text-secondary-d1">
                          <?php echo "Bed: ".$value->no_of_bed." Baths: ".$value->no_of_baths."  Fee: ".$value->total_fee;?>
                        </div>
                      </td>
					...
					<div class="modal fade modal-fs" id="modalFullscreen" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                      ...
                      <td class="align-middle">
                       <div class='d-none d-lg-flex'>
								...
								<button type="button" class="click_to_load_modal_popup mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-danger btn-a-lighter-danger"  id="<?php echo $value->post_code.'_'.$value->rent_amount.'_'.$value->available_date.'_'.$value->no_of_bed;?>" data-toggle="modal" data-target="#modalFullscreen" onClick="GFG_click(this.id)"> Matched Tenant</button>
                               ...
                               <a href="<?php echo base_url() . "index.php/super_admin/delete_property/" . $value->id; ?>" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-danger btn-a-lighter-danger" onClick="return confirm('Are you sure you want to Delete?');">
                              ...
                              <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                                ...
                                <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                  <div class="dropdown-inner">
                                    ...
                                    <a href="<?php echo base_url() . "index.php/super_admin/delete_property/" . $value->id; ?>" class="dropdown-item">

                ...
                <div class="card bcard">
                  <div class="card-header">
                    ...
                    <div class="card-toolbar pl-3">
					 <h3 class="card-title text-125" align="right">
                  <i class="fa fa-eye text-dark-l3 mr-1"></i>
				  	<a href="<?php echo base_url();?>index.php/super_admin/room_list">
                  	Room List
					</a>
                </h3>&nbsp;&nbsp;
                  ...
                  <div class="card-body">
                    ...
                    <div id="smartwizard-1" class="d-none mx-n3 mx-sm-auto">
                      ...
                      <div class="px-2 py-2 mb-4">
                        <div id="step-1">
                          <form action="<?php echo base_url();?>index.php/super_admin/save_room" id="first" method="post"  class="mt-lg-3"  enctype="multipart/form-data">
                            	
								<div class="form-group form-row mt-4">
									<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="room_id">
								...
								<div class="form-group form-row mt-4">
									...
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="room_status">
										<option value="" selected="selected"> Room Status</option>
								...
								<div class="form-group form-row mt-4">
									...
									<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									 ...
									 <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="min_term">
									  <span class="floating-label text-grey-m3">
										Minimum term (month)
									</span>
									...
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="max_term">
									  <span class="floating-label text-grey-m3">
										Maximum term (month)
									</span>
								...
								<div class="form-group form-row mt-4">
									...
									<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
										<input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="vat">
									  <span class="floating-label text-grey-m3">
										VAT (&pound;)
										</span>
									</div>
									 <div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="deposit">
									  <span class="floating-label text-grey-m3">
										Deposit (&pound;)
									</span>
									...
									<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									  <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="bill_included">
										<option value="" selected="selected">Bill Included</option>
									...
									<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									  <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="furnishings">
										<option value="" selected="selected">Furnishings</option>
										<option value="1">Furnished</option>
									    <option value="0">Unfurnished</option>
									    <option value="2">Partial Furnished</option>
									  </select> 
									</div>
									<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									 <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="parking">
									...
									<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									 <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="garage">
								...
								<div class="form-group form-row mt-4">
									...
									<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
										<select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="garden_terrace">
										<option value="" selected="selected">Garden/terrace</option>
									    <option value="1">Yes</option>
									    <option value="0">No</option>
									  </select> 
									</span>
									 ...
									 <div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									<select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="belcony_patio">
										<option value="" selected="selected">Balcony/Patio</option>
									    <option value="1">Yes</option>
									    <option value="0">No</option>
									  </select> 
									</span>
									...
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="disabled_access">
										<option value="" selected="selected">Disabled access</option>
									    <option value="1">Yes</option>
									    <option value="0">No</option>
									  </select> 
									</span>
									...
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="living_room">
										<option value="" selected="selected">Living room</option>
										<option value="1">Shared</option>
									    <option value="2">Non-Shared</option>
									    <option value="3">Exclusive</option>
									  </select> 
									</div>
									<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									 <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="broadband">
										<option value="" selected="selected">Broadband</option>
									    <option value="1">Yes</option>
									    <option value="0">No</option>
									  </select> 
									</span>
								...
								<div class="form-group form-row mt-4"><strong>Current Household:</strong></div>
								<div class="form-group form-row mt-4">
									
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="no_of_flatmates">
									  <span class="floating-label text-grey-m3">
										No. of Flatmates
										</span>
									</div>
									 <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="total_room">
									  <span class="floating-label text-grey-m3">
										Total Rooms
										</span>
									</span>
									...
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="h_age">
									...
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="h_smoker">
										<option value="" selected="selected">Smoker?</option>
									    <option value="1">Yes</option>
									    <option value="0">No</option>
									  </select> 
									</div>
								...
								<div class="form-group form-row mt-4">
									<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									 <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="h_pets">
									...
									<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									  <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="h_language">
									...
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="h_nationality">
									...
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
										  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="h_occupation">
									  <span class="floating-label text-grey-m3">
										Occupation
										</span>
									</span>
									 ...
									 <div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
									<select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="h_gender">
								...
								<div class="form-group form-row mt-4"><strong>New Flatmate Preferences</strong></div>
								<div class="form-group form-row mt-4">
									
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									 <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="couple">
										<option value="" selected="selected">Couples OK?</option>
									    <option value="1">Yes</option>
									    <option value="0">No</option>
									  </select>
									</div>
									 <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="new_smoke">
										<option value="" selected="selected">Smoking OK?</option>
									    <option value="1">Yes</option>
									    <option value="0">No</option>
									  </select>
									</div>
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="new_pets">
										<option value="" selected="selected">Pets OK?</option>
									    <option value="1">Yes</option>
									    <option value="0">No</option>
									  </select> 
									</div>
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
										  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="new_occupation">
									  <span class="floating-label text-grey-m3">
										Occupation
										</span>
									</span>
								...
								<div class="form-group form-row mt-4">
								<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									 <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="new_reference">
									...
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="new_mini_age">
									  <span class="floating-label text-grey-m3">
										Min age
										</span>
									</div>
								<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="new_max_age">
									  <span class="floating-label text-grey-m3">
										Max age
										</span>
									</div>
									 ...
									 <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									<select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="new_gender">
										<option value="" selected="selected">Gender</option>
									    <option value="Male">Male</option>
									    <option value="Female">Female</option>
									  </select> 
                        ...
                        <div id="step-2">
								...
								<div class="form-group form-row mt-4">
									...
									<hr />
										<textarea id="summernote" name="room_title"></textarea>
										<hr />
									</div>
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									 <select class="form-control" id="form-control form-control-lg col-sm-8 col-md-12 shadow-none" style="height:49px;" name="room_type">
									...
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="id-form-field-2" name="house_volumn">
									  <span class="floating-label text-grey-m3">House Volumn</span>
									</div>
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
								...
								<div class="form-group form-row mt-4">
									<div class="col-sm-12 input-floating-label text-blue-d2 brc-blue-m1">
									<span>Room Details</span><hr />
										<!--<textarea class="form-control" name="content" id="markdown-editor" rows="10"></textarea> -->
										<textarea id="summernote1" name="room_details"></textarea>
									</div>
									
								</div>
								<div class="form-group form-row mt-4">
									<span>Room Features</span><hr />
									<div class="col-sm-12 input-floating-label text-blue-d2 brc-blue-m1">
										<!--<textarea class="form-control" name="content" id="markdown-editor1" rows="10"></textarea> -->
										<textarea id="summernote2" name="room_features"></textarea>
									</div>
								</div>
								<div class="form-group form-row mt-4">
									<span>Room Conclusion</span><hr />
									<div class="col-sm-12 input-floating-label text-blue-d2 brc-blue-m1">
										<textarea id="summernote3" name="room_conclusion"></textarea>
									</div>
								</div>
                        ...
                        <div id="step-4" class="text-center">
                          <h3 class="text-400 text-success mt-4"> Room Details </h3>
                          Now you are going to save details information by clicking <strong>Finish</strong> button
                          <br>
                          <br>
                          <br>
                          <br>

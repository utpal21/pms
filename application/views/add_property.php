<?php echo $common_pageheader; ?>
              ...
              <div class="col-12">
                <div class="card bcard">
                  ...
                  <i class="fa fa-eye text-dark-l3 mr-1"></i>
				  	<a href="<?php echo base_url();?>index.php/super_admin/property_list">
                  	Property List
					</a>
                </h3>&nbsp;&nbsp;
    ...
    <div class="px-2 py-2 mb-4">
      	<form action="<?php echo base_url();?>index.php/super_admin/save_property" id="first" method="post"  class="mt-lg-3"  enctype="multipart/form-data;charset=utf-8">
      <div id="step-1">
        <?php 
          $csrf = array(
        ...
        ?>
           <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />               
              ...
              <div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
                <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="" name="property_id">
                <span class="floating-label text-grey-m3">
                  Property ID
                </span>									
              </div>
              <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
                <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="" name="house_name_no">
                <span class="floating-label text-grey-m3">
                  House Name/Number
                </span>									
              </div>
              <div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
                <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="" name="street_road_no">
                <span class="floating-label text-grey-m3">
                  Street/Road Number
                </span>
              </div>
              <div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
                <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="" name="post_code">
                <span class="floating-label text-grey-m3">
                  Post Code
                </span>
              </div>
                  ...
                  <option value="10">10</option>
						...
						<div class="form-group form-row mt-4">									
							<div class="col-sm-4 input-floating-label text-blue-d2 brc-blue-m1">
								<input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="" name="city_location">
								<span class="floating-label text-grey-m3">
							...
							<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
								<input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="" name="rent_amount">
								<span class="floating-label text-grey-m3">
									Rent (£)
								</span>
							</div>
          ...
          <div class="form-group form-row mt-4">
						...
						<div class="col-sm-2 input-floating-label text-blue-d2 brc-blue-m1">
							<input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="" name="viewing_time">
							<span class="floating-label text-grey-m3">
								Viewing Time 
							</span>
						</div>
                        ...
                        <div id="step-2">
								...
								<div class="form-group form-row mt-4">
									...
									<div class="col-sm-3 input-floating-label text-blue-d2 brc-blue-m1">
									  <input type="text" class="form-control form-control-lg col-sm-8 col-md-12 shadow-none" id="" name="no_of_baths">
                ...
                <div id="step-4" class="text-center">
                  <h3 class="text-400 text-success mt-4"> Property Details </h3>
    ...
    <script>
      $("#file-1").fileinput({
            theme: 'fa',
            uploadUrl: "<?php echo base_url();?>index.php/super_admin/do_property_upload",

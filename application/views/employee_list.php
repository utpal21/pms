            ...
            <div class="page-header mb-2 pb-2 flex-column flex-sm-row align-items-start align-items-sm-center py-25 px-1">
              <h1 class="page-title text-primary-d2 text-140">
                ...
                <small class="page-info text-dark-m3">
                  ...
                  showing all employee here
                </small>
              </h1>
			   <h3 class="page-title text-primary-d2 text-120">
			   	<a href="<?php echo base_url();?>index.php/super_admin/add_employee"><i class="fa fa-plus"></i>
                Add New</a>
               </h3>
                      ...
                      <td class="align-middle">
                       <div class='d-none d-lg-flex'>
                                <a href="#" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                  ...
                                  <a href="<?php echo base_url() . "index.php/super_admin/delete_employee/" . $value->id; ?>" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-danger btn-a-lighter-danger" onClick="return confirm('Are you sure you want to Delete?');">

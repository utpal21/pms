          ...
          <div role="main" class="page-content container container-plus">
            <div class="page-header mb-2 pb-2 flex-column flex-sm-row align-items-start align-items-sm-center py-25 px-1">
              <h1 class="page-title text-primary-d2 text-140">
                ...
                <small class="page-info text-dark-m3">
                  ...
                  showing all Landlord here
                </small>
              </h1>
			   <h3 class="page-title text-primary-d2 text-120">
			   	<a href="<?php echo base_url();?>index.php/super_admin/add_landlord"><i class="fa fa-plus"></i>
                Add New</a>
               </h3>
            ...
            <div class="card bcard h-auto">
                ...
                <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed">
                  ...
                  <tbody class="pos-rel">
				  <?php foreach ($landlord_list as $value){ 
                    ...
                    <td class="text-grey">
                      ...
                      <td class="align-middle">
                       <div class='d-none d-lg-flex'>
                                ...
                                <a href="<?php echo base_url() . "index.php/super_admin/edit_landlord/" . $value->id; ?>" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                                  <i class="fa fa-pencil-alt"></i>
                                </a>

                               <a href="<?php echo base_url() . "index.php/super_admin/delete_landlord/" . $value->id; ?>" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-danger btn-a-lighter-danger" id="id-bootbox-confirm">
                              ...
                              <div class='dropdown d-inline-block d-lg-none dd-backdrop dd-backdrop-none-lg'>
                                ...
                                <div class="dropdown-menu dd-slide-up dd-slide-none-lg">
                                  <div class="dropdown-inner">
                                    ...
                                    <a href="<?php echo base_url() . "index.php/super_admin/delete_landlord/" . $value->id; ?>" class="dropdown-item">
                                      <i class="fa fa-trash-alt text-danger-m1 mr-1 p-2 w-4"></i>
                                      Delete
                                    </a>
                                    <a href="<?php echo base_url() . "index.php/super_admin/view_landlord/" . $value->id; ?>" class="dropdown-item">

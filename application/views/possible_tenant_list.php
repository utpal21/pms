...
if (isset($_POST['matched_property']) ? $_POST['matched_property'] : '') {
    $tenant_id = $_POST['tenant_id']; 
    $query="SELECT * FROM tenant WHERE id = $tenant_id";
    ...
    $home_arr = array();
   // foreach($_POST['tenant_id'] as $row){
   foreach($_POST['id'] as $row){
        $home_arr[$row] = $row;
    }
    $home_id_str = join(',', $home_arr);
    $query="SELECT * FROM property WHERE id IN($home_id_str) order by id DESC";
    $res = mysqli_query($con,$query);  
	...
	$home_address .="<li>" . $property_address . "</li>";
    }
    $home_address .="</ul>";
    
    //START EMAIL
    $sender_mail = 'ashad.ce@gmail.com';
    $date_mail = date("d/m/Y");
    $subject_title = "Matched Property";
    $message_details = $home_address;

    $message = "<strong>Details:</strong>&nbsp;" . $message_details;
  
    //$to = $arrg_email_1unId . 'ashad.ce@gmail.com' . ',' . $arrg_email_1unId . 'ashad.ce@gmail.com';
          ...
          <div role="main" class="page-content container container-plus">
            ...
            <div class="card bcard h-auto">
                ...
                <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed">
                  ...
                  <tbody class="pos-rel">
				  <?php foreach ($possible_tenant_list as $value1){ 
				 ...
				 /* include APPPATH.'views/db_connection.php';
				  ...
				  ?>
                    <tr class="d-style bgc-h-default-l4">
                      ...
                      <td>
                        <span class="text-105">
                            <?php echo $value1->firstname." ".$value1->surname;?>
                        </span>
                        <div class="text-95 text-secondary-d1">
                          <?php echo $value1->profession;?>
                        </div>
                      </td>

                    <td class="text-grey">
                       <span class="text-105">
                            <?php echo $value1->contact;?>
                        </span>
                        <div class="text-95 text-secondary-d1">
                          <?php echo $value1->post_code;?>
                        </div>
                      </td>

                      <td class="text-600 text-grey-d1">
                       <span class="text-105">&pound; 
                            <?php echo $value1->max_rent;?>
                        </span>
                        <div class="text-95 text-secondary-d1">
                          <?php echo $value1->suitable_contact_time;?>
                        </div>
                      </td>

                      <td class="text-grey">
                       <span class="text-105">
                            <?php echo $value1->no_of_bed." - ".$value1->no_of_occupy;?>
                        </span>
                        <!--<div class="text-95 text-secondary-d1">
                      ...
                      <td>
                       <span class="text-105">
                            <?php echo $value1->move_in_date;?>
                        </span>
                        <div class="text-95 text-secondary-d1">
                          <?php echo $value1->move_out_date;?>
                        </div>
                      </td> 
					...
					<div class="modal fade modal-fs" id="modalFullscreen" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                      ...
                      <td class="align-middle">
                       <div class='d-none d-lg-flex'>
								...
								<button type="button" class="click_to_load_modal_popup mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-danger btn-a-lighter-danger"  id="<?php echo $value1->post_code.'_'.$value1->max_rent.'_'.$value1->move_in_date.'_'.$value1->no_of_bed;?>" data-toggle="modal" data-target="#modalFullscreen" onClick="GFG_click(this.id)"> Matched Property</button>
					   			...
					   			<a href="<?php echo base_url() . "index.php/super_admin/tenant_arrange_viewing/" . $value1->id; ?>" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-danger btn-a-lighter-danger" data-toggle="tooltip" data-placement="top" title="Arrange Viewing" id="tooltip-1">
